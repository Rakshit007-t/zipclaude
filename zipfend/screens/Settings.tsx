...
const Settings: React.FC = () => {
  ...
  const toggleUserRole = async () => {
    showToast("Seller dashboard is unavailable in this demo.", "error");
  };
            ...
            <div className="flex flex-col bg-white dark:bg-[#1E1E1E] rounded-[2rem] border border-black/5 dark:border-white/5 overflow-hidden shadow-sm">
                ...
                {sellerStatus === 'approved' && (
                    <div className="flex items-center gap-4 p-4 opacity-60">
                        ...
                        <div className="flex-1">
                            <div className="font-bold text-sm text-[#111111] dark:text-white">Seller Dashboard</div>
                            <div className="text-[11px] text-[#555555] dark:text-[#A0A0A0]">Unavailable in this demo build</div>
                        </div>
                        <span className="material-symbols-outlined text-[#555555] dark:text-[#A0A0A0]">lock</span>
                    </div>
                )}
            </div>
        </div>
