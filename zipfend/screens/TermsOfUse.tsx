    ...
    <div className="flex flex-col min-h-screen bg-[#111111] text-white" style={{ fontFamily: 'DM Sans, sans-serif' }}>
      ...
      <div className="sticky top-0 z-50 flex items-center justify-between px-6 py-5 bg-[#111111]/90 backdrop-blur-xl border-b border-white/5">
        ...
        <div className="text-center">
          <h1 className="text-[10px] font-bold tracking-[0.3em] uppercase text-[#C9A06C]">Terms of Use</h1>
      ...
      <div className="px-6 pt-8 pb-6 border-b border-white/5">
        <div className="flex items-center gap-4 mb-4">
          <div className="h-14 w-14 rounded-2xl bg-[#C9A06C]/10 border border-[#C9A06C]/20 flex items-center justify-center flex-shrink-0">
            <span className="material-symbols-outlined text-2xl text-[#C9A06C]">gavel</span>
          </div>
          <div>
            <h2 className="text-xl font-black tracking-tight" style={{ fontFamily: 'Cormorant Garamond, serif' }}>
              <span className="text-white">Zip</span><span className="text-[#C9A06C]">RIGHT</span> Terms of Use
            </h2>
            <p className="text-[10px] text-white/40 mt-0.5 uppercase tracking-widest">Legally Binding Agreement</p>
          </div>
        </div>
        <div className="bg-[#FF4D6D]/10 border border-[#FF4D6D]/20 rounded-2xl p-4">
          <p className="text-[11px] text-white/70 leading-relaxed">
            <span className="text-[#FF4D6D] font-black">Important: </span>
      ...
      <div className="flex-1 px-4 py-4 pb-24">
        {sections.map((section, idx) => (
          <div key={idx} className="mb-2 border border-white/5 rounded-2xl overflow-hidden">
            ...
            >
              <span className="text-[12px] font-black text-white/90 pr-4 leading-tight">{section.title}</span>
        ...
        <div className="mt-6 p-4 bg-white/3 border border-white/5 rounded-2xl">
          ...
          <p className="text-[10px] text-[#C9A06C]/60 text-center mt-2">legal@zipright.in</p>
        </div>
      </div>
    </div>
  );
