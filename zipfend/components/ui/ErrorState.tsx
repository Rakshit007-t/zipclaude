...
const ErrorState: React.FC<ErrorStateProps> = ({
  ...
  <div role="alert" className={cn('flex flex-col items-center justify-center text-center px-8 py-16', className)}>
    <div className="h-16 w-16 rounded-full border border-danger/30 bg-danger-soft flex items-center justify-center mb-5">
      <span className="material-symbols-outlined text-danger text-[28px]" aria-hidden="true">
        error
      </span>
    </div>
