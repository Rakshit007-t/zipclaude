...
const variantClasses: Record<ButtonVariant, string> = {
  primary:
    'bg-brand text-on-brand hover:bg-brand-strong shadow-glow disabled:shadow-none',
...
/**
 * The app's button. Pill-shaped, spring press feedback, built-in loading
 * state that preserves layout width.
 */
const Button: React.FC<ButtonProps> = ({
  ...
  return (
    <button
      ...
      className={cn(
        'relative inline-flex items-center justify-center rounded-full font-semibold tracking-tight select-none',
        'transition-[transform,background-color,box-shadow,opacity] duration-150 ease-swift active:scale-[0.97]',
